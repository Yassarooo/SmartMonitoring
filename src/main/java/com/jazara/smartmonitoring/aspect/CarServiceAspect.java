package com.jazara.smartmonitoring.aspect;
...
public class CarServiceAspect {
    ...
    @Before("execution(* com.jazara.smartmonitoring.service.CarService.getAllCars())")
    public void beforeGetCar() {
        auth = SecurityContextHolder.getContext().getAuthentication();
        System.out.println("Get All Cars - by " + auth.getName());
    }

    @Before("execution(* com.jazara.smartmonitoring.service.CarService.createOrUpdateCar(com.jazara.smartmonitoring.domain.Car , Boolean )) && args(c,update)")
    ...
    @AfterReturning("execution(* com.jazara.smartmonitoring.service.CarService.createOrUpdateCar(com.jazara.smartmonitoring.domain.Car , Boolean )) && args(c,update)")
    ...
    @Before("execution(* com.jazara.smartmonitoring.service.CarService.deleteCarById(Long)) && args(id)")
    public void beforedeleteCar(Long id) {
        auth = SecurityContextHolder.getContext().getAuthentication();
        System.out.println("delete Car - ID" + id + " - by " + auth.getName());
    }

    @AfterReturning("execution(* com.jazara.smartmonitoring.service.CarService.deleteCarById(Long)) && args(id)")
    public void afterdeleteCar(Long id) {
        auth = SecurityContextHolder.getContext().getAuthentication();
        System.out.println("deleted Car - ID" + id + " - by " + auth.getName());
    }

    @Before("execution(* com.jazara.smartmonitoring.service.CarService.getCarById(Long)) && args(id)")
